...
def _shoelaceGenerateHtml(element_def: ElementDef, name: str) -> str:
    ...
    func = {
        ...
        'sl-drawer': lambda: f'''<sl-drawer data-name="{name}" open label="Drawer" placement="end" class="drawer-placement-start">
            <span>Drop elements here.<br>To close the drawer with Python set {name}.open=False<br>In html, remove the attribute `open`</span></sl-drawer>''',
        ...
        'sl-image-comparer': lambda: f'''<sl-image-comparer>
