...
from wwwpy.resources import library_resources, from_filesystem
...
def quickstart():
    resources = iterlib.repeatable_chain(library_resources(), from_filesystem(parent, relative_to=parent.parent))
