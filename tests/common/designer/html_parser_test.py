...
def test_nested():
    ...
    expect = [CstNode(tag_name='div', span=(0, 18), attr_span=(4, 4),
                      children=[CstNode(tag_name='p', span=(5, 12), attr_span=(7, 7))])]
    assert actual == expect


def test_nested_with_attributes_and_spaces():
    actual = html_to_tree('<div   id="div1" > <p ></p> </div> ')
    children = [CstNode(tag_name='p', span=(19, 27), attr_span=(21, 22))]
...
def test_void_tags():
    ...
    expect = [CstNode(tag_name='div', span=(0, 18), attr_span=(4, 4),
                      children=[CstNode(tag_name='input', span=(5, 12), attr_span=(11, 11))])]
    assert actual == expect
...
def test_void_tags_with_attributes_and_spaces():
    ...
    expect = [CstNode(tag_name='div', span=(0, 34), attr_span=(4, 4), children=children)]
    assert actual == expect
...
def test_issue20240727():
    ...
    expect = [CstNode(tag_name='div', span=(0, 19), attr_span=(4, 4),
                      children=[CstNode(tag_name='input', span=(5, 13), attr_span=(11, 11))]),
